...
})({"c5UwO":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "2e168a3414ca6d56";
"use strict";
...
},{}],"evtnJ":[function(require,module,exports,__globalThis) {
...
searchButton.addEventListener("click", async (e)=>{
    e.preventDefault();
    dialog.classList.add("grid", "grid-cols-1", "md:grid-cols-2", "lg:grid-cols-2", "gap-4");
    const searchResults = await (0, _networkJs.fetchSearchMovies)(searchInput.value);
    searchResults.forEach((searchResult)=>{
        const card = (0, _uiJs.createCard)(searchResult);
        dialog.prepend(card);
    });
    dialog.showModal();
});
...
closeButton.addEventListener("click", ()=>{
    dialog.classList.remove("grid", "grid-cols-1", "md:grid-cols-2", "lg:grid-cols-2", "gap-4");
    dialog.close();
});
...
window.addEventListener("load", async ()=>{
    const hotMovies = await (0, _networkJs.fetchHotMovies)();
    hotMovies.forEach((hotMovie)=>{
        const card = (0, _uiJs.createCard)(hotMovie);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["c5UwO","evtnJ"], "evtnJ", "parcelRequire2e4b", {})

//# sourceMappingURL=TMDB-Diary-WD65.14ca6d56.js.map
