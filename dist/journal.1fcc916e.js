...
//fetchPopularMovies();
//added-------------------------!!!!!!!!!!!!!!!!!!!!!!!!!
(0, _networkJs.fetchPopularMovies)().then((movies)=>{
    allMovies = movies;
    (0, _uiJs.displayMovies)(allMovies, moviesContainer, handleClick);
});
fetchGenres();
//Movie card-------------------------------------------------------
...
function filterMoviesByGenres() {
    ...
    //added---------------------!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    (0, _uiJs.displayMovies)(filtered, moviesContainer, handleClick);
}
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    if (searchInput) searchInput.addEventListener("input", (e)=>{
        ...
        //added----------------------------------!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        (0, _uiJs.displayMovies)(searchResults, moviesContainer, handleClick);
    });
}); //remove-----------------------------------------------------!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 ...
 //   <img class="bg-contain" src="${
 //    IMAGE_BASE + movie.poster_path
 //  }" width=100% alt="${movie.title}" class="h-80 object-cover">
 //   <div class="p-4">
...
},{"./network.js":"5n0lb","./ui.js":"4OwKy"}],"5n0lb":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchSearchMovies", ()=>fetchSearchMovies);
parcelHelpers.export(exports, "fetchHotMovies", ()=>fetchHotMovies);
parcelHelpers.export(exports, "fetchPopularMovies", ()=>fetchPopularMovies);
parcelHelpers.export(exports, "fetchRecommendations", ()=>fetchRecommendations);
parcelHelpers.export(exports, "IMAGE_BASE", ()=>IMAGE_BASE);
parcelHelpers.export(exports, "QUERY_SUFFIX", ()=>QUERY_SUFFIX);
// API data
const API_KEY = "ae9417b72a04e975455b2ed2ac2a7001";
const BASE_URL = "https://api.themoviedb.org/3";
...
const options = {
    ...
    headers: {
        ...
        Authorization: "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlZjYwMGEyYTkxMDhmMTAzN2MzYmRmYjg2NWRjN2FlOSIsIm5iZiI6MTc1MjEzMjA4NC4yNzksInN1YiI6IjY4NmY2OWY0M2MzMDg0YWMzY2U4MDlkZSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.jomYGTIz91zlRE7ptaJxuK4MI_ooTJU1c12rMVhCk-s"
    }
};
// function searchMovies
async function fetchSearchMovies(movieName) {
    try {
        const response = await fetch(`${BASE_URL}/search/movie?query=${movieName.replaceAll(" ", "%20")}&language=en-US`, options);
        const data = await response.json();
        return data.results;
    } catch (error) {
        console.error("Error fetching popular movies:", error);
...
async function fetchPopularMovies() {
    try {
        const response = await fetch(`${BASE_URL}/movie/popular?language=en-US&page=1&api_key=${API_KEY}`);
        const data = await response.json();
        return data.results;
    } catch (error) {
        console.error("Error fetching popular movies:", error);
...
parcelHelpers.export(exports, "displayMovies", ()=>displayMovies);
var _networkJs = require("./network.js");
var _storageJs = require("./storage.js");
// create movie card
function createCard(movie) {
    const card = document.createElement("div");
    card.classList.add("bg-gray-800", "rounded-lg", "shadow-lg", "min-w-[15vw]", "relative", "z-10");
    ...
    img.src = (0, _networkJs.IMAGE_BASE) + movie.poster_path;
    img.alt = `${movie.title}`;
    ...
    title.classList.add("text-lg", "font-bold", "mb-2", "truncate", "text-nowrap");
    ...
    addToFavsBtn.className = "bg-transparent hover:bg-blue-400 font-extrabold text-2xl text-black rounded-full bolded justify-self-start absolute right-5 top-5";
    addToFavsBtn.addEventListener("click", ()=>{
        (0, _storageJs.addMovieToFavs)(movie);
...
function displayMovies(movies, container, onClick) {
    ...
    movies.forEach((movie)=>{
        ...
        if (typeof onClick === "function") card.addEventListener("click", ()=>onClick(movie));
        container.appendChild(card);
    });
}

},{"./network.js":"5n0lb","./storage.js":"fSzBB","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fSzBB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addMovieToFavs", ()=>addMovieToFavs);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["iUuJv","fILKw"], "fILKw", "parcelRequire2e4b", {})

//# sourceMappingURL=journal.1fcc916e.js.map
